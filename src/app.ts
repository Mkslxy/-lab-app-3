...
class App {
    ...
    private initUI() {
        ...
        bookForm?.addEventListener('submit', (e) => {
            e.preventDefault();
            const title = (document.querySelector<HTMLInputElement>('#bookTitle')!.value || '').trim();
            const author = (document.querySelector<HTMLInputElement>('#bookAuthor')!.value || '').trim();
            const year = parseInt(document.querySelector<HTMLInputElement>('#bookYear')!.value);
        ...
        userForm?.addEventListener('submit', (e) => {
            e.preventDefault();
            const name = (document.querySelector<HTMLInputElement>('#userName')!.value || '').trim();
            const email = (document.querySelector<HTMLInputElement>('#userEmail')!.value || '').trim();
        ...
        const booksContainer = document.querySelector<HTMLDivElement>('#booksList')!;
        ...
        const usersContainer = document.querySelector<HTMLDivElement>('#usersList')!;
